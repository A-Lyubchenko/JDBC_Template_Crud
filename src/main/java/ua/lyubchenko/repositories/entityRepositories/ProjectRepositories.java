...
public class ProjectRepositories implements IRepositories<Project> {
    ...
    public void create(Project entity) {
        jdbcTemplate.update("INSERT INTO projects (id,name,start,salary) VALUES(?,?,?,?)",
                entity.getId(), entity.getName(), entity.getStart(), entity.getCoast());
    }
    ...
    public void update(int id, Project entity) {
        jdbcTemplate.update("UPDATE projects SET name = ?, start = ?, coast = ? WHERE id = ?",
                entity.getName(), entity.getStart(), entity.getCoast(), id);
